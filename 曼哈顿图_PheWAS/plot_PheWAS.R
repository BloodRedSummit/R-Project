...
# 读取数据----
data <- read.csv('ATP2A1_cont_0814T133844Z_AZ_PheWAS_Portal.csv')


# 调用绘图函数----
plot_PheWAS(
    data = data,
    type = 'cont', # 数据类型 binary/cont， binary: Binary traits, cont: Continuous traits
    title = 'ATP2A1', # 图片title
    pic_type = 'png', # 图片类型，png/tiff/pdf
    dir_save = './plot' # 结果路径
)
